...
class ReadSign():
    ...
    def YOLO(self, cvImage):
        # Trained YOLO models
        modelSign = YOLO("/home/fizzer/ENPH353_Competition/src/car_controller/neural/YOLO/FindSign.pt")
        modelLetters = YOLO("/home/fizzer/ENPH353_Competition/src/car_controller/neural/YOLO/20251201.pt")
        ...
        if len(results) == 1:
            ...
            if box is None or len(box) == 0:
                ...
                message = modelLetters(source=cropped_image_np, conf=0.25, save=True, project = "/home/fizzer/ENPH353_Competition/src/car_controller/neural/Read20251130")
